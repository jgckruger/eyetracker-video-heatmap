...
img_heatmapper = Heatmapper(colours='default', point_strength=0.9, point_diameter=150, opacity=0.9)
video_heatmapper = VideoHeatmapper(img_heatmapper)
video = video_heatmapper.heatmap_on_video_path(video_path, points, heat_fps=25, keep_heat=True, heat_decay_s=5)
